...
<body>
    <div class="shell">
        <header class="topbar"><a class="brand" href="<?= site_url('products'); ?>">product<span>/</span>archive</a><nav><a href="<?= site_url('products'); ?>">Back to archive</a></nav></header>
        <main class="form-frame">
            ...
            <form class="form" method="post" action="<?= htmlspecialchars($form_action); ?>">
                ...
                <div class="form-actions"><button class="button" type="submit">Save product</button><a class="button secondary" href="<?= site_url('products'); ?>">Cancel</a></div>
            </form>
        </main>
    </div>
</body>
